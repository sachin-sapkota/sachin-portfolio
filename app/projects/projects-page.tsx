...
import jobxaProj from '@/public/images/jobxa_proj.png';
import detourProj from '@/public/images/detour_proj.png';
import clinicExpertProj from '@/public/images/clinic_expert.png';
import x8cProj from '@/public/images/x8c_proj.png';
import aakhyaanProj from '@/public/images/aakhyan_proj.png';
...
function FeaturedProject({
  ...
  return (
    <article className="w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl lg:p-12 relative flex-col lg:flex-row md:p-8 p-4">
      ...
      <div className="lg:w-1/2 w-full flex flex-col items-start justify-between lg:pl-6">
        ...
        <div className="mt-2 flex items-center justify-between w-full">
          {github === 'private' ? null : (
            <Link href={github} target="_blank" rel="noreferrer" className="w-10">
              <GithubIcon />
            </Link>
          )}
          <Link
...
function Project({ type, title, image, link, github }: ProjectProps) {
  return (
...
export default function ProjectsPage() {
  return (
    <main className="flex w-full flex-col items-center justify-center dark:text-light">
      <div className="pt-16 px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 w-full h-full inline-block z-0">
        <AnimatedText
