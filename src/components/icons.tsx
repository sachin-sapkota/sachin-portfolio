...
export const GithubIcon = ({ className, ...rest }: classnameType) => (
  <svg
...
export const BuyMeCoffee = ({ className, ...rest }: classnameType) => (
  <svg
    {...rest}
    className={`w-full h-auto ${className}`}
    fill="#000000"
...
export const TwitterIcon = ({ className, ...rest }: classnameType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
// #0A66C2
export const LinkedInIcon = ({ className, ...rest }: classnameType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const PinterestIcon = ({ className, ...rest }: classnameType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const DribbleIcon = ({ className, ...rest }: classnameType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const CircularText = ({ className, ...rest }: classnameType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="496"
    height="496"
...
export const LinkArrow = ({ className, ...rest }: classnameType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
    height={24}
